...
var isQuitted = false;
var fromPrev = false;
var daTorch = document.getElementById("torch");
var daChest = document.getElementById("chest")
...
let skincard10 = document.createElement("div");
...
let skincard = [skincard1, skincard2, skincard3, skincard4, skincard5, skincard6, skincard7, skincard8, skincard9, skincard10];
...
let boycow = ["https://pbs.twimg.com/media/EoNjQRqXUAAd8Mv?format=png&name=240x240", "https://pbs.twimg.com/media/EoNjh7iXUAA6pCE?format=png&name=120x120", "https://pbs.twimg.com/media/EoNjnfhW8AAoPsC?format=png&name=120x120", "https://pbs.twimg.com/media/EoNjr_OW8AAuRNI?format=png&name=120x120", "https://pbs.twimg.com/media/EoNjv8wXYAI8PYX?format=png&name=120x120", "false", 2, "BOYCOW"];
...
let cowboyWizard = ["https://pbs.twimg.com/media/EmlQA1aXMAIBPvg?format=png&name=240x240", "https://pbs.twimg.com/media/EmlQHPBXEAA3BH0?format=png&name=120x120", "https://pbs.twimg.com/media/EmlQNlhXYAUCKI6?format=png&name=120x120", "https://pbs.twimg.com/media/EmlQTJlW4AAvO7w?format=png&name=120x120", "https://pbs.twimg.com/media/EmlQZWCXcAIAfAO?format=png&name=120x120", "false", 3, "WIZARD COWBOY"];
let spacecowboy = ["https://pbs.twimg.com/media/Eml1HnjWEAITeiY?format=png&name=240x240", "https://pbs.twimg.com/media/Eml1P9pWMAAYm0J?format=png&name=120x120", "https://pbs.twimg.com/media/Eml1W80XYAAfgj3?format=png&name=120x120", "https://pbs.twimg.com/media/Eml1dGoW4AMDr_U?format=png&name=120x120", "https://pbs.twimg.com/media/Eml1h0GWMAQt5nu?format=png&name=120x120", "false", 3, "SPACE COWBOY"];
let cowboysanta = ["https://pbs.twimg.com/media/EmrtmHLXIAEP4yj?format=png&name=240x240", "https://pbs.twimg.com/media/EmrtxBkXYAAuOTL?format=png&name=120x120", "https://pbs.twimg.com/media/Emrt2i6W8AExISW?format=png&name=120x120", "https://pbs.twimg.com/media/Emrt_kSW8AAt77X?format=png&name=120x120", "https://pbs.twimg.com/media/EmruFHQW4AARryx?format=png&name=120x120", "false", 3, "COWBOY SANTA"];
let coboykarate = ["https://pbs.twimg.com/media/Emr-T9mXYAI-IXW?format=png&name=240x240", "https://pbs.twimg.com/media/Emr-cS0W8AMkIYz?format=png&name=120x120", "https://pbs.twimg.com/media/Emr-hEsW8AACsOb?format=png&name=120x120", "https://pbs.twimg.com/media/Emr-k5bXEAAPW2G?format=png&name=120x120", "https://pbs.twimg.com/media/Emr-pArXUAIAtAD?format=png&name=120x120", "false", 2, "KARATE COWBOY"];
let coyboyxmas = ["https://pbs.twimg.com/media/EmsDQGrXMAAxu1_?format=png&name=240x240", "https://pbs.twimg.com/media/EmsDjW1W8AETysH?format=png&name=120x120", "https://pbs.twimg.com/media/EmsDn3OXIAAQZrZ?format=png&name=120x120", "https://pbs.twimg.com/media/EmsDsJCW8AEOHtQ?format=png&name=120x120", "https://pbs.twimg.com/media/EmsDwa2XcAAAQzL?format=png&name=120x120", "false", 1, "XMAS COWBOY"];
let cowboybus = ["https://pbs.twimg.com/media/EmsPMWDW8AAegGc?format=png&name=240x240", "https://pbs.twimg.com/media/EmsPXt8XYAQ3hTi?format=png&name=120x120", "https://pbs.twimg.com/media/EmsPdLlWEAAWllc?format=png&name=120x120", "https://pbs.twimg.com/media/EmsPhwVWEAAZzz3?format=png&name=120x120", "https://pbs.twimg.com/media/EmsPmcJWEAIOFdl?format=png&name=120x120", "false", 1, "WORK COWBOY"];
let cowboymcfly = ["https://pbs.twimg.com/media/EmsS7YCW4AA0pYz?format=png&name=240x240", "https://pbs.twimg.com/media/EmsTJnfXUAAJ6Kw?format=png&name=120x120", "https://pbs.twimg.com/media/EmsT5l7XEAISJaf?format=png&name=120x120", "https://pbs.twimg.com/media/EmsT-IJXMAECqcW?format=png&name=120x120", "https://pbs.twimg.com/media/EmsUC-iW8AAG7EX?format=png&name=120x120", "false", 3, "COWBOY MCFLY"];
...
let skinList = [cowboy, cowboybus, coyboyxmas, coboykarate, cowboyWizard, spacecowboy, cowboysanta, cowboymcfly, cowboybat, boycow];
let lootList = [100, 200, 300, 400, 500, cowboybus, coyboyxmas, coboykarate, boycow, cowboyWizard, spacecowboy, cowboysanta, cowboymcfly, cowboybat];
...
var restarted = false;
var user = {currLevel: 1, xpLevel: 0, currHealth: 100, currKill: 0, totalKill: 0, coins: 3000, skin: 1, killedThisGame: 0, highscore: 0, key: 0};
...
class greenMonster {
  constructor(health, speed, spawnx, spawny) {
    this.idid = Math.floor(Math.random() * 380) + 100;
    this.health = health;
    this.speed = speed;
    this.spawnx = spawnx;
    this.dead = false;
  ...
  doUnPause() {
    ...
    this.inter = setInterval(this.frame2.bind(this), 15);
  }
  doUnPause2() {
    this.gamePaused = false;
    //this.whatToDo(this.img.style.left, this.img.style.top);
  ...
  whatToDo(x, y) {
    ...
    //this.inter = setInterval(frame.bind(this), 15);
...
function startGame() {
  ...
  if (dagame.webkitRequestFullscreen) {
  dagame.webkitRequestFullscreen();
}
else if (dagame.requestFullscreen) {
  dagame.requestFullscreen()
}
else {
  console.log("Use Dif Browser");
}
  killHomeAnimate = true;
  fromPrev = false;
}
  ...
  daTorch.style.left = (620/1280) * w;
  daTorch.style.top = (100/737) * h;
  daChest.style.left = (1000/1280) * w;
  daChest.style.top = (150/737) * h;
  ...
  rocky = Math.floor(Math.random() * 380) + 150;
  rock2x = Math.floor(Math.random() * 850) + 200;
  rock2y = Math.floor(Math.random() * 380) + 150;
  rock3x = Math.floor(Math.random() * 850) + 200;
  rock3y = Math.floor(Math.random() * 380) + 150;
...
function pauseGame() {
  var limit;
  if (unlock) {
    limit = user.currLevel - 1;
  }
  else {
    limit = user.currLevel;
  }
